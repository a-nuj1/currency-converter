...
function App() {
  ...
  return (
    ...
    style={{
       backgroundImage : `url('https://d27735ao2xxhhe.cloudfront.net/blog/pro/understanding-the-role-of-currency-exchange-rates-in-international-money-transfers-1000x70064f83932954ab1693989170.png' )`,
  }}>
    ...
    <div className='w-full'>
      <div className='w-full max-w-lg mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30'>
        ...
        onSubmit={(e)=>{
          ...
          <div className='realtive w-full h-1'>
            <button
              type='button'
